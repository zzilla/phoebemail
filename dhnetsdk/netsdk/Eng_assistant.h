...
enum 
{
	...
	EN_ACFCONTROL,						// Frame rate control activities. Bitwise 1£ºsupport frame rate control activities
...
typedef struct  
{
	int nItemNum;						//Valid number of DSP_CFG_ITEM, equals to channel number
	DSP_CFG_ITEM	stuDspCfgItem[32];	//Main code stream Information
