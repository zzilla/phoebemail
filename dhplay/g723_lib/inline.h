...
inline Word16 sature(Word32 L_var1);
...
inline Word16 extract_l(Word32 L_var1)
{
    Word16 var_out;
...
/*
#define SATURE(L_var1)                   						\
	{															\	
	    if (L_var1 >0X00007fffL){Overflow = 1;L_var1 = MAX_16;} \
	    else {													\
	        if (L_var1 < (Word32)0xffff8000L) {					\	
	            Overflow = 1;									\
	            L_var1 = MIN_16;								\
...
/*inline Word16 sub(Word16 var1,Word16 var2)
{
    Word16 var_out;
    Word32 L_diff;
...
inline Word16 extract_h(Word32 L_var1)
{
    Word16 var_out;
...
inline Word16 round(Word32 L_var1)
{
    Word16 var_out;
    Word32 L_arrondi;
...
inline Word32 L_add_c(Word32 L_var1, Word32 L_var2)
{
    ...
    L_var_out = L_var1 + L_var2 + (Word32)Carry_g723;
...
/*inline Word16 mult_r(Word16 var1, Word16 var2)
{
    ...
    L_produit_arr += (Word32) 0x00004000L;        
...
inline Word32 L_deposit_h(Word16 var1)
{
    Word32 L_var_out;
...
inline Word32 L_deposit_l(Word16 var1)
{
    Word32 L_var_out;
...
inline Word32 L_sat (Word32 L_var1)
{
    Word32 L_var_out;
...
inline Word16 div_s(Word16 var1, Word16 var2)
{
...
inline Word32   L_mls( Word32 Lv, Word16 v )
{
   Word32   Temp  ;
...
inline Word16 div_l( Word32  L_num, Word16 den ){
...
_inline Word16 sature(Word32 L_var1);
...
*/
_inline Word32   L_mls( Word32 Lv, Word16 v )
{
   Word32   Temp  ;
...
_inline Word16 div_l( Word32  L_num, Word16 den ){
