...
#ifndef HI_MULTI_THREAD_DECODER
/*********************************************************************************
...
/**************************************************************************
* Function Name  : Hi264DecFrame
* Description    : input stream and decode (muti-thread version)
* Parameters     : hDec       :         decoder handle created by HI_H264DEC_Create
*                : pStream    :         stream buffer
*                : iStreamLen :  stream length in byte
*                : ullPTS     :  time stamp
...
/*********************************************************************************
* Function Name  : Hi264DecGetPicture
* Description    : Get a picture from picture pool inside decoder
* Parameters     : hDec      :  decoder handle created by HI_H264DEC_Create
*                : pDecFrame :  denoting whether there is a picture frame to display,
*                               and the decoded Parameters of the picture frame
*                               (referring to H264_DEC_FRAME_S )
...
* Last Modified  : 2007-8-27
**********************************************************************************/
HI_S32 HI_DLLEXPORT Hi264DecGetPicture( HI_HDL hDec, H264_DEC_FRAME_S *pDecFrame );

/********************************************************************************
* Function Name  : Hi264DecReleasePicture
* Description    : return a picture to decoder
* Parameters     : hDec      :  decoder handle created by HI_H264DEC_Create
*                : pDecFrame :  denoting whether there is a picture frame to display,
*                               and the decoded Parameters of the picture frame
*                               ( referring to H264_DEC_FRAME_S )
...
* Last Modified  : 2007-8-27
*********************************************************************************/
HI_S32 HI_DLLEXPORT Hi264DecReleasePicture( HI_HDL hDec, H264_DEC_FRAME_S *pDecFrame );
