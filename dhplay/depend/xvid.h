 ...
 ****************************************************************************/
	...
	typedef struct
	{
		...
		int postproc_level;//2003-02-08 zyd		
		int	bDeInterlace;
	}
	XVID_DEC_FRAME;
...
#define XVID_DEC_WATERMARK	255 
/**
 * WaterMark 
 * This operation constant is used by the client application to start/stop/set 
 * WaterMark infomation
 */
